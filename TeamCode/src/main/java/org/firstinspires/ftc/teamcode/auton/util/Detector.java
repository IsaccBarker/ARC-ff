...
public class Detector {
  ...
  // Webcam constants:
  private static final String WEBCAM_CONFIG_NAME = "webcam";
  ...
  private static final int THRESHOLD =
      500; // Any amount of red/blue pixels greater than THRESHOLD is considered as a (visible)
           // marker.
                ...
                public void onConfigured(@NonNull CameraCaptureSession session) {
                  try {
                    ...
                    session.startCapture(
                        ...
                        Continuation.create(
                            callbackHandler,
                            (session12, cameraCaptureSequenceId, lastFrameNumber) ->
                                RobotLog.ii(
                                    TAG,
