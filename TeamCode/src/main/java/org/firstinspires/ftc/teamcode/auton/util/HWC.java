...
public class HWC {
  ...
  public HWC(@NonNull HardwareMap hardwareMap, Telemetry telemetry) {
    ...
    // Run motors using encoder, so that we can move accurately. If motor doesn't have, run without
    // encoder
  ...
  public void driveAndArm(
      double distanceInCm, double wheelRPower, double wheelLPower, double aCounts) {
    int wheelCounts = 0;
